...
module.exports = async () => {
  ...
  const [publicAddress, localPort, remoteAddress, remotePort = localPort] = process.argv.slice(3)
  const { sock } = await dial(+localPort, publicAddress, +remotePort, remoteAddress, { secure })
